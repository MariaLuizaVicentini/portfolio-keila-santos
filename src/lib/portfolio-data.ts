export const portfolioLinks = {
  ...
  whatsapp: "https://api.whatsapp.com/send/?phone=5511942440037&text&type=phone_number&app_absent=0",
...
export const projects: Project[] = [
  {
    ...
    description: "Clínica especializada em tratamentos para diferentes tipos de dor, com atuação em mídia paga para captação de novos pacientes.",
    work: [
      "Campanhas",
  ...
  },
  {
    ...
    platforms: "Google Ads + Meta Ads",
    description: "Empresa do setor elétrico com atuação na fabricação e comercialização de transformadores para aplicações industriais.",
    work: [
  ...
  },
  {
    ...
    description: "Empresa com diferentes soluções de engenharia, incluindo teste de estanqueidade, resina e individualização de água e gás.",
    ...
    objective: "Gerar oportunidades para as diferentes soluções e serviços de engenharia oferecidos pelo Grupo MJ.",
    strategy:
  ...
  },
  {
    ...
    platforms: "Meta Ads",
    description: "Empreendimento residencial com diferentes opções de plantas e configurações de apartamentos.",
    work: [
    ...
    objective: "Gerar interesse e oportunidades para o lançamento imobiliário, alcançando potenciais compradores dentro do perfil definido para o empreendimento.",
    strategy:
...
export const capabilities = [
  {
    title: "TRÁFEGO PAGO",
    items: ["Google Ads", "Meta Ads", "YouTube Ads", "ChatGPT Ads", "Estruturação e configuração de campanhas", "Segmentação", "Palavras-chave", "Públicos", "Análise de termos de pesquisa", "Palavras-chave negativas", "Acompanhamento de orçamento"],
  },
  {
    title: "PERFORMANCE E DADOS",
    items: ["Análise de métricas", "CTR", "CPC", "CPA", "Conversões", "Performance das campanhas", "Identificação de oportunidades", "Otimização baseada em dados"],
  },
  {
    title: "MENSURAÇÃO",
    items: ["Google Analytics 4", "Google Tag Manager", "Configuração e acompanhamento de eventos", "Conversões", "Análise de comportamento e resultados"],
  },
  {
    title: "ESTRATÉGIA",
    items: ["Entendimento de objetivos de campanha", "Análise de público", "Estrutura de campanhas", "Apoio na estratégia dos clientes", "Acompanhamento de reuniões com clientes e equipe"],
  },
];
...
export const certifications: Certification[] = [
  ...
  { issuer: "M2UP", title: "Facebook e Instagram Ads PRO", duration: "20,5 h", year: "2026", href: null },
  ...
  { issuer: "Complexo Argos", title: "Informática Básica", duration: "76 h", year: "2016", href: null },
  { issuer: "Complexo Argos", title: "Microsoft Office Intermediário", duration: "148 h", year: "2017", href: null },
];